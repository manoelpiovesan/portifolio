...
//     var dataText = [ "seja ", "bem vindo(a)", "ao meu", "portifólio", "role para baixo!"];
...
//        document.querySelector("#text-animated-home").innerHTML = text.substring(0, i+1) +'<span aria-hidden="true"></span>';
...
Letters = function() {
  ...
  var word = [  "HTML&CSS", "JAVASCRIPT", "REACTJS" , "DEV. WEB" , "NODEJS", "BOOTSTRAP", "GIT & GITHUB"];
  var nextWord = 1;
